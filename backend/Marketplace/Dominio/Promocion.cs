...
namespace Marketplace.Dominio
{
    public class Promocion
    {
        ...
        public bool AplicaA(Publicacion publicacion)
        {
            ...
            if (CategoriaAplicable != null &&
                publicacion.Producto.Categoria != CategoriaAplicable)
                return false;

            if (VendedorAplicable != null &&
                publicacion.Vendedor.IdUsuario != VendedorAplicable.IdUsuario)
                return false;

            if (ProductoAplicable != null &&
                publicacion.Producto.IdProducto != ProductoAplicable.IdProducto)
                return false;

            if (PrecioMinimo != null &&
                publicacion.Precio < PrecioMinimo)
                return false;

            if (PrecioMaximo != null &&
                publicacion.Precio > PrecioMaximo)
                return false;
        ...
        public static Promocion? MejorPromocionPara(
